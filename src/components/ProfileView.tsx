...
import { User as UserIcon, Shield, Mail, Phone, Utensils, CheckCircle, Clock } from 'lucide-react';

export const ProfileView: React.FC = () => {
  const { currentUser, responses, bills, settings } = useApp();
    ...
    <div className="space-y-6 pb-12 animate-in fade-in duration-300">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm flex flex-col sm:flex-row items-center gap-6">
        <img
          ...
          className="w-20 h-20 rounded-full object-cover border-4 border-indigo-500/30 shadow-md"
        />
